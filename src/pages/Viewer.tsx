...
export default function Viewer() {
  ...
  return (
    <div className="min-h-screen pt-16 flex flex-col">
      {/* Header */}
      <div className="border-b border-white/5 px-4 sm:px-6 py-4 bg-[#080c14]/80 backdrop-blur-sm">
            ...
            {[
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
                  value
                    ? 'bg-blue-600/30 text-cyan-400 border border-cyan-400/30'
      ...
      <div className="flex-1 relative" style={{ minHeight: '600px' }}>
          ...
          <Suspense
            fallback={
              <div className="w-full h-full flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-slate-500 text-sm animate-pulse">Initializing 3D renderer…</p>
              </div>
            }
          >
            <PCScene
        ...
        <div className="absolute bottom-6 left-0 right-0 flex justify-center pointer-events-none z-10">
          <div className="flex items-center gap-4 glass rounded-full px-4 py-2 border border-white/5">
      ...
      {/* Info panel */}
      <div className="border-t border-white/5 bg-[#080c14]/80 backdrop-blur-sm">
